...
3. **Self-fix** - Fix mechanical local issues; hand design or scope findings to the main session and continue independent checks
4. **Run verification** - Run project's lint and typecheck commands

## Important Constraints

- Fix mechanical local issues yourself. The main session continues approved-scope implementation for handed-back findings; the handoff does not end the task.
- Fix introduced failures within the approved scope. Distinguish existing or environmental failures with evidence; blocked required verification is not a pass.
