...
Impact analysis is a technical prerequisite, not permission to edit. It must
answer for the repository you are about to edit. Pure explanatory text has no
symbol-impact requirement; inspect actual consumers for runtime configuration,
generated templates, and agent instructions. Keep explicit operation approvals.
HIGH/CRITICAL requires a risk warning, not an extra approval question; UNKNOWN
requires investigation and must never be reported as low risk.
