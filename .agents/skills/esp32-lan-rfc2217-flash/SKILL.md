...
- Allowed remote: `192.168.2.108/32`
- Firewall rule: `ESP_COM3_TCP_Bridge_4000`
- Recorded listener PID: `43276`
- Known-good local validation: `esptool read_mac` succeeds; MAC is
  `20:e7:c8:5f:ab:a4`
...
- Use RFC2217 for this bridge; do not use `socket://192.168.2.10:4000`.
