...
class MainActivity : Activity() {
    ...
    override fun onCreate(state: Bundle?) { super.onCreate(state); registerReceiverCompat(castStatusReceiver, CastService.ACTION_STATUS); readDeepLink(intent); content(); connectExistingWifiOrLoadInfo() }
